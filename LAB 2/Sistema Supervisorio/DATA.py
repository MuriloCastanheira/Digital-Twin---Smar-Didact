...
while True:
    ...
    pacote = [10000 + Quant_Agua_Saida_Reservatorio, 20000 + Quant_Bomba_1_Reservatorio,30000 +  Quant_Bomba_2_Reservatorio, 40000 +  Vazao_Valvula1,50000 +  Vazao_Valvula2,60000 +  Quant_Agua_Tanque_Aquecimento,70000 +  Tempo_Processo_Tanque_Aquecimento,80000 +   Quant_Agua_Saida_Tanque_Aquecimento,90000 +   Temp_Agua_Tanque_Aquecimento,100000 + Quant_Agua_Tanque_Mistura,110000 +   Quant_AguaQuente_Tanque_Mistura, 120000 +   Quant_AguaFria_Tanque_Mistura,130000 +   Tempo_Processo_Tanque_Mistura,140000 +    Quant_Agua_Saida_Tanque_Mistura]
    for i in pacote:
